...
|--------|---------|-------------|
| **[aida-core](https://github.com/oakensoul/aida-core-plugin)** | v0.8.0 | Foundation plugin for building your custom Claude Code experience. Extension scaffolding, multi-level configuration, and structured session context. |
